        ...
        {type !== "list" && (
          <>
            ...
            <p className="headerDesc">
              Tatilin Nerede Başlasın, Biz Planlayalım!
            </p>
            {!user && <button className="headerBtn">Giriş Yap / Kayıt Ol</button>}
            <div className="headerSearch">
              <div className="headerSearchItem">
                <FontAwesomeIcon icon={faBed} className="headerIcon" />
                <input
                  type="text"
                  placeholder="Nere Böyle Bileyim Söyle"
              ...
              <div className="headerSearchItem">
                ...
                <span
                  ...
                  className="headerSearchText"
                >{`${options.adult} yetişkin · ${options.children} çocuk · ${options.room} oda`}</span>
                {openOptions && (
